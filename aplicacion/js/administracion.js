...
let root, acceso, config, asesores = [], ciudades = [], asesorCiudades = {}, revision = 0;
...
async function equipo(){
 ...
 await cargarCiudades();await cargarAsesorCiudades();
...
async function ciudadesTab(){
 ...
 el.onclick=async e=>{
  const ciudadId=e.target.dataset.delCiudad;const festivoId=e.target.dataset.delFestivo;const guardarId=e.target.dataset.guardarCiudad;
